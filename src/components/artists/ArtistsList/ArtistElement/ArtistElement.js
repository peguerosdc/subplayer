...
export class ArtistElement extends React.Component {
    ...
    render() {
        ...
        return (
            <Col id="name" key={artist.id} sm={8} xs={12} className={currentArtistPlayingId === artist.id ? "link_to_artist playing" : "link_to_artist"} onClick={ (e) => {navigate("/artists/"+artist.id)} }>
