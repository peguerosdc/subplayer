...
class SongsTableEnhanced extends React.Component {
    ...
    render() {
        ...
        return (
            <div style={{backgroundColor:"white", padding:"5px", ...style}}>
                <div style={{display:"flex", flexFlow:"row"}}>
                    {showSearchFilter && <SearchBar size="md" style={{marginLeft:"10px"}} onSearch={this.onFilterSongs}/> }
                ...
                <SongsTable {...rest} songsFilter={filterValue} onSongsSelected={this.onSongsSelected} />
            </div>
        )
    }
